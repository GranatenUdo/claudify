...
Provide comprehensive integration guide", subagent_type="Researcher")
...
Provide architectural blueprint with diagrams", subagent_type="Tech Lead")
...
Provide security implementation checklist", subagent_type="Security Reviewer")
