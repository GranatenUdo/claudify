...
Provide aggressive modernization blueprint with zero legacy constraints", subagent_type="Tech Lead")
...
Design assuming no legacy security constraints", subagent_type="Security Reviewer")
...
Design for 100% coverage with modern tools only", subagent_type="Test Quality Analyst")
