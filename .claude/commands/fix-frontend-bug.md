...
Provide UX-focused bug assessment and fix requirements", subagent_type="UX Reviewer")
...
Provide security risk assessment and mitigation requirements", subagent_type="Security Reviewer")
...
Provide UX validation report", subagent_type="UX Reviewer")
...
Provide final approval or improvement requirements", subagent_type="Code Reviewer")
...
Provide architectural guidance and improvement recommendations", subagent_type="Tech Lead")
...
Provide simplification recommendations if applicable", subagent_type="Code Simplifier")
