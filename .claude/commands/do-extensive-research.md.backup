...
5. Common pitfalls
6. Success stories
Provide evidence-based findings", subagent_type="Researcher")
...
5. Best practices
Provide security assessment", subagent_type="Security Reviewer")
...
5. Future-proofing
Provide architectural recommendations", subagent_type="Tech Lead")
