...
Generate specific test examples for critical gaps with confidence scores", subagent_type="Test Quality Analyst")
...
Provide top 10 test code improvements with examples", subagent_type="Code Reviewer")
...
Prioritize security test additions by risk level", subagent_type="Security Reviewer")
...
Rate test architecture maturity 1-10", subagent_type="Tech Lead")
