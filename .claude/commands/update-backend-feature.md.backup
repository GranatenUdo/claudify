...
Provide technical implementation plan with risk assessment", subagent_type="Tech Lead")
...
Provide security checklist with validation steps", subagent_type="Security Reviewer")
...
Provide refactoring recommendations", subagent_type="Code Reviewer")
...
Provide test implementation plan for 100% coverage", subagent_type="Test Quality Analyst")
